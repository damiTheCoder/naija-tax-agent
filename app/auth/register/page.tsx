  ...
  return (
    <div className="min-h-screen bg-white px-4 py-4 text-slate-950">
      ...
      <section className="w-full rounded-[24px] border border-transparent bg-white p-5 shadow-none sm:p-6">
        <p className="text-[10px] font-black uppercase tracking-[0.26em] text-[#1e3a8a]">Get started</p>
        ...
        <p className="mt-5 text-sm text-slate-500">
          ...
          <Link href={`/auth/login?next=${encodeURIComponent(next)}`} className="font-black text-[#1e3a8a]">
            Sign in
          </Link>
        </p>
