        ...
        <div className="mt-6 grid grid-cols-3 gap-3">
          {([
            ...
            return (
              ...
              >
                <span className={`flex h-10 w-10 items-center justify-center rounded-full ${isActive ? "bg-[#8fff00] text-[#101010]" : "bg-transparent text-gray-700"}`}>
      ...
      <section className="grid gap-4 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="p-1 sm:p-0">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#8fff00] text-xl font-black text-[#101010]">
          ...
          <div className="mt-6 grid gap-3">
            <label className="block">
              ...
              <input
                ...
                inputMode="decimal"
                placeholder="0.00"
                className="mt-2 h-14 w-full rounded-2xl border border-gray-100 bg-transparent px-4 text-lg font-bold text-gray-950 outline-none focus:border-[#8fff00]"
              />
            </label>
            <label className="block">
              ...
              <input
                ...
                className="mt-2 h-14 w-full rounded-2xl border border-gray-100 bg-transparent px-4 text-sm font-semibold text-gray-950 outline-none focus:border-[#8fff00]"
              />
            </label>
          </div>
          ...
          <button
            type="button"
            className="mt-5 flex h-14 w-full items-center justify-center rounded-2xl bg-[#8fff00] text-sm font-black text-[#101010] transition-colors hover:bg-[#7be000]"
          >
            {selected.title}
          </button>
