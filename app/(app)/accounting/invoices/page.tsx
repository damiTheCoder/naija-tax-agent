                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-3 mb-2">
                                                <span
                                                    ...
                                                    style={{ color: theme === "dark" ? "#c9f58a" : "#446b00" }}
                                                >
                    ...
                    >
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <button
                                    onClick={addLineItem}
                                    className="mt-3 inline-flex items-center gap-2 text-sm font-medium text-[#446b00] hover:text-[#446b00] transition-colors"
                                >
                                    {icons.plus}
                                    Add Line Item
                                </button>
                            ...
                            >
                                ...
                                <div className="flex justify-between text-lg font-bold pt-2 border-t" style={{ borderColor: theme === "dark" ? "#333" : "#e5e7eb" }}>
                                    ...
                                    <span style={{ color: "#446b00" }}>{formatCurrency(invoiceTotals.total)}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <button
                                ...
                                className="px-4 py-2.5 rounded-lg font-semibold text-sm bg-[#8fff00] text-white hover:bg-[#6fcc00] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Create Invoice
                            </button>
                        </div>
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="space-y-1 text-sm">
                                ...
                                <div className="flex justify-between text-lg font-bold pt-2">
                                    <span style={{ color: theme === "dark" ? "#fff" : "#111827" }}>Total</span>
                                    <span style={{ color: "#446b00" }}>{formatCurrency(selectedInvoice.total)}</span>
                                </div>
                            </div>
