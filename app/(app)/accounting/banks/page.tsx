      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg bg-[#2563eb] text-white hover:bg-[#1d4ed8]"
          >
            {icons.plus}
            Connect Bank
          </button>
            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#2563eb] focus:border-[#2563eb] outline-none bg-white"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#2563eb] focus:border-[#2563eb] outline-none"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 text-sm font-medium text-white bg-[#2563eb] rounded-lg hover:bg-[#1d4ed8] disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-2"
                >
                  {isUploading ? (
                    <>
