    ...
    <div className="space-y-6 px-4 py-6 sm:px-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        <div className="p-4 rounded-xl border bg-white border-gray-200/60">
          <p className="text-xs font-semibold uppercase tracking-wide text-[#1e3a8a]">VAT Payable</p>
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-lg border border-gray-200 px-3 py-2 text-sm focus:ring-2 focus:ring-[#2563eb] focus:border-transparent"
            >
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`inline-flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap rounded-t-md ${activeTab === tab.id
                  ? "border-[#2563eb] text-[#1e3a8a] bg-[#E8F4FF]"
