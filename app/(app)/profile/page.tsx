          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="rounded-lg bg-[#2563eb] px-3.5 py-1.5 text-xs font-semibold text-white hover:bg-[#1d4ed8] disabled:cursor-not-allowed disabled:opacity-60"
              >
        ...
        <section className={`rounded-3xl border p-5 sm:p-6 lg:col-span-5 ${isDark ? "border-gray-700" : "border-gray-200"}`}>
          ...
          <div className="mt-4 flex gap-2">
            ...
            <button
              ...
              className="rounded-xl bg-[#2563eb] px-3 py-2 text-xs font-semibold text-white hover:bg-[#1d4ed8] disabled:cursor-not-allowed disabled:opacity-50"
            >
              Create
            </button>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                      ...
                      {editingWorkspaceId === workspace.id ? (
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="rounded-lg bg-[#2563eb] px-2.5 py-1.5 text-[11px] font-semibold text-white"
                          >
                            Save
                          </button>
                        </div>
                    ...
                    {isCurrent ? (
                      <span className={`rounded-full border px-2 py-0.5 text-[10px] font-semibold ${isDark ? "border-gray-700 text-gray-200" : "border-gray-200 text-[#1e3a8a]"}`}>
                        Active
                      </span>
                    ) : (
                      <button
