            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link
                  ...
                  className="rounded-xl bg-[#2264ff] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#1c52d4]"
                >
                  Sign in
                </Link>
                <Link
            ...
            <form onSubmit={handleCreateComplaint} className="mt-5 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2 text-sm focus:border-[#2264ff] focus:outline-none focus:ring-2 focus:ring-[#2264ff]/20"
                />
              </div>
              ...
              <button
                ...
                className="rounded-xl bg-[#2264ff] px-4 py-2 text-sm font-semibold text-white hover:bg-[#1a50cc] disabled:opacity-60"
              >
          ...
          <section className="rounded-3xl border border-slate-200 bg-white p-5 sm:p-6">
            ...
            <form onSubmit={handleSearch} className="mt-4 grid gap-3 sm:grid-cols-[1fr_180px_auto]">
              <input
                ...
                className="rounded-xl border border-slate-300 px-3 py-2 text-sm focus:border-[#2264ff] focus:outline-none focus:ring-2 focus:ring-[#2264ff]/20"
              />
              <select
                value={statusFilter}
            ...
            <div className="space-y-5">
              ...
              <form onSubmit={handleReply} className="rounded-2xl border border-slate-200 px-4 py-4">
                ...
                <textarea
                  ...
                  className="mt-4 w-full rounded-xl border border-slate-300 px-3 py-2 text-sm focus:border-[#2264ff] focus:outline-none focus:ring-2 focus:ring-[#2264ff]/20"
                />

                <button
                  type="submit"
                  disabled={replyLoading || !replyMessage.trim()}
                  className="mt-3 rounded-xl bg-[#2264ff] px-4 py-2 text-sm font-semibold text-white hover:bg-[#1a50cc] disabled:opacity-60"
                >
