      ...
      <section className="rounded-xl border border-slate-200 bg-white p-4">
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
          <input
            ...
            className="rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-[#2264ff] focus:outline-none focus:ring-2 focus:ring-[#2264ff]/20"
          />
          <select
            value={status}
                ...
                {items.map((item) => (
                  <tr key={item.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3 text-right">
                      <Link href={`/admin/complaints/${item.id}`} className="font-medium text-[#2264ff] hover:text-[#1a50cc]">
                        Open
                      </Link>
                    </td>
                  </tr>
