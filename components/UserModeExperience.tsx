...
const CONNECTED_APPS = [
  { name: "Zenith Business", type: "Bank feed", status: "Streaming", accent: "#9080ee", impact: "+₦4.8M inflow", initial: "Z" },
          ...
          <div className="flex-1 overflow-y-auto px-2 md:px-6 pt-4 md:pt-6 pb-24 md:pb-36 space-y-3 md:space-y-5">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold" style={{ color: '#4a3880' }}>
                      ...
                      <div key={message.id} className={`px-3 md:px-5 py-3 ${isDark ? 'hover:bg-gray-900/30' : 'hover:bg-gray-50/50'} transition-colors`}>
                        <div className={`flex ${message.role === "user" ? "justify-end" : "justify-start"}`}>
                          <div className={`max-w-lg rounded-2xl px-4 py-3 text-sm space-y-1.5 ${message.role === "assistant"
                            ...
                            : isDark ? 'bg-gray-800 border border-gray-700' : 'bg-[#f3f0ff] border border-[#e2daff]'
                            }`}>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1 relative">
                        <textarea
                          ...
                          rows={1}
                          className={`w-full resize-none rounded-2xl border px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#9080ee] ${isDark
                      ...
                      <button
                        ...
                        style={{
                          background: composer.trim() ? "linear-gradient(135deg,#9080ee,#6f5ce0)" : isDark ? "#000000" : "rgba(148,163,184,0.4)",
