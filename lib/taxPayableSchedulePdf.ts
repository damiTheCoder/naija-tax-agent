...
export function generateTaxPayableSchedulePDF(data: TaxPayableScheduleData): void {
    ...
    doc.text("Quantum Ledger", pageWidth / 2, y, { align: "center" });
    y += 10;
    ...
    for (let i = 1; i <= totalPages; i++) {
        ...
        doc.setTextColor(...grayColor);
        doc.text(
            `Page ${i} of ${totalPages} | Generated by Quantum Ledger Tax Engine`,
            pageWidth / 2,
            pageHeight - 10,
            { align: "center" }
        );
