...
export function generatePDF(
    ...
    doc.setFontSize(8);
    doc.setTextColor(...grayColor);
    doc.text("Quantum Ledger", pageWidth / 2, y + 5, { align: "center" });
    doc.text("Generated by Quantum Ledger", pageWidth / 2, pageHeight - 15, { align: "center" });

    // Save the PDF
    doc.save(`quantum-ledger-tax-computation-${result.taxYear}.pdf`);
}
