/**
 * Client-side PDF Generator for Insight
 * 
...
export function generatePDF(
    ...
    doc.text("Insight", pageWidth / 2, y + 5, { align: "center" });
    y += 10;
    ...
    doc.setFontSize(8);
    doc.setTextColor(...grayColor);
    doc.text("Generated by Insight", pageWidth / 2, pageHeight - 15, { align: "center" });

    // Save the PDF
    doc.save(`insight-tax-computation-${result.taxYear}.pdf`);
}
