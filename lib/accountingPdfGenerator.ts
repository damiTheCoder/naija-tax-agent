/**
 * Accounting PDF Generator for Atom Ledger
 * 
...
function drawFooter(doc: jsPDF, pageWidth: number, pageHeight: number): void {
    ...
    doc.setTextColor(...LIGHT_GREY);
    doc.text(
        `Generated by Atom Ledger on ${new Date().toLocaleDateString("en-NG", { dateStyle: "long" })}`,
        pageWidth / 2,
        pageHeight - 10,
        { align: "center" }
    );
...
export async function generateIncomeStatementPDF(
    ...
    businessName: string = "Atom Ledger Business",
